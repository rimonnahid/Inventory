        ...
        <div class="col-lg-12">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <form action="{{ URL::to('add_setting') }}" method="POST" enctype="multipart/form-data">
                    	@csrf
                        ...
                        <div class="form-group  row"><label class="col-sm-2 col-form-label text-right">Mobile</label>
                            <div class="col-sm-10"><input type="text" name="mobile" class="form-control"><span class="form-text m-b-none"></span></div> 
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group  row"><label class="col-sm-2 col-form-label text-right">Country</label>
                            <div class="col-sm-10"><input type="text" name="country" class="form-control"><span class="form-text m-b-none"></span></div> 
                        </div>
                        <div class="hr-line-dashed"></div>


                        <div class="form-group  row"><label class="col-sm-2 col-form-label text-right">Zipcode</label>
                            <div class="col-sm-10"><input type="number" name="zipcode" class="form-control"><span class="form-text m-b-none"></span></div> 
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4 col-sm-offset-2">
                                <button class="btn btn-primary btn-sm" type="submit">Add Settings</button>
                            </div>
                        </div>
                    </form>
                </div>
