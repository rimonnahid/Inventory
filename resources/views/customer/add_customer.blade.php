                ...
                <div class="ibox-content">
                    <form action="{{ URL::to('add_customer') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group  row"><label class="col-sm-2 col-form-label text-right">Shop Name</label>
                            <div class="col-sm-10"><input type="text" name="shopname" class="form-control"><span class="form-text m-b-none"></span></div> 
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group  row"><label class="col-sm-2 col-form-label text-right">Bank Branch</label>
                            <div class="col-sm-10"><input type="text" name="bank_branch" class="form-control"><span class="form-text m-b-none"></span></div> 
                        </div>
                        <div class="hr-line-dashed"></div>
